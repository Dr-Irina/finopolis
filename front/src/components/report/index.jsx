  ...
  return (
    <>
      <div
        ...
        onClick={() =>
          history.push(
            reverse(paths.reportDetails, {
              id: report.categoryId,
              subId: report.subCategoryId,
              reportId: report.id,
            })
          )
        }
        ...
        <div>
          <div className={styles.headerContainer}>
            ...
            <p
              className={cx({
                ...
                [styles.inProgress]:
                  report.status.toLowerCase() === 'на рассмотрении',
          ...
          <div className={styles.textContainer}>
            <p className={styles.text}>
              Текст обращения текст обращения текст обращения текст обращения
              текст обращения текст обращения текст обращения текст обращения
              Текст обращения текст обращения текст обращения текст обращения
              текст обращения текст обращения текст обращения текст обращения
              текст ...
